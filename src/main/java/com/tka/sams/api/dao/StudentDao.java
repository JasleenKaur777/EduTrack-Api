	...
	public Student updateStudent(Student studentDetails) {
		 Student student = null;
	        ...
	        try (Session session = factory.openSession()) {
	            ...
	            // Fetch the existing student from DB
	            student = session.get(Student.class, studentDetails.getId());

	            if (student != null) {
	                // Update the fetched student entity
	                ...
	                System.out.println("Student not found with ID: " + studentDetails.getId());
	            }
	        } catch (Exception e) {
	            if (transaction != null) {
